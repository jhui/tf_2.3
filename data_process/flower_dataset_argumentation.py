...
# it uses the directory names as the class names
...
# The first approach of normalizing data
...
# the second approach use the normalization model as part of the model
# create the model

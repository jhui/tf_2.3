...
# print the total for NA on each attribute
...
# Build a model using a single input feature
...
# Build a model using multiple input features
...
# print the performance of all trained models
